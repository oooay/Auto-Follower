...
namespace HybridAStar
{
  ...
  public:
    ...
    void showLine(double x, double y);
  ...
  private:
    ...
    ros::Publisher pubIntersections;
    tf::TransformListener listener;
    ros::Time time1;
    nav_msgs::OccupancyGridPtr grid;
    geometry_msgs::PoseStamped optimal_goal;
    geometry_msgs::PolygonStamped detectedBorder;
    //geometry_msgs::PolygonStamped robot_to_target;
    visualization_msgs::Marker intersections_successed;
    visualization_msgs::Marker intersections_failed;
    visualization_msgs::Marker robot_to_target;
    geometry_msgs::Quaternion q;

    double goal_time;
    bool goal_updated;
    double x0, y0, x1, y1, r1, x2, y2, r2, x3, y3, x4, y4, dxy2;
