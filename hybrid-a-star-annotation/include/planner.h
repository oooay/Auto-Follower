   ...
   */
   ...
   public:
      ...
      */
      ...
      void calcLinear();
      void showBorder();
      nav_msgs::Path polynomialFit(const nav_msgs::Path newPath);
   ...
   private:
      ...
      // helon
      ros::Publisher pubVelocity; // linear的发布器
      ros::Publisher pubCarBorder;
      ros::Publisher pubDetectedBorder;
      ros::Time t0;
      std_msgs::Float32 vel;
      geometry_msgs::PolygonStamped carBorder;
      geometry_msgs::PolygonStamped detectedBorder;
      vector<nav_msgs::Path> paths;

      double distObs;
      double distObsMax = 3.6; // m
      double distGoal;
      double distGoalMax = 10; // m
      double kDistObs = 0.05;
      double kDistGoal = 0.1;
