...
namespace HybridAStar
{
  ...
  */
  namespace Constants
  {
    ...
    static const bool manual = false; // true表示静态地图；false表示动态地图
    ...
    static const bool reverse = false; // true表示可以倒退；false表示只能前进不能倒退
    ...
    static const bool dubins = true; // Dubin路径的切换开关: 若车子可以倒退，值为false
    /*!
    ...
    */
    ...
    static const double width = 0.4 + 2 * bloating; // 车的宽度
    /// [m] --- The length of the vehicle
    static const double length = 0.6 + 2 * bloating; // 车的长度
    /// [m] --- The minimum turning radius of the vehicle
    static const float r = 1.5; // 最小转弯半径
    ...
    */
    ...
    // helon
    static const std::string global_frame = "map";
    static const std::string base_frame = "base_link";
    static const std::string map_frame = "local_map";
    static const std::string target_frame = "target";
  }
}
